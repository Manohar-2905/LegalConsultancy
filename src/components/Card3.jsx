        ...
        >
          ...
          <div className="w-full md:w-1/2 md:pl-12">
            ...
            <p className="text-justify text-gray-800 text-base leading-relaxed mb-6">
              Compliance with healthcare regulations can be daunting, but with
              R&A Legal and Insurance Consultancy, it doesn’t have to be. We
              provide dedicated regulatory compliance support tailored for
              healthcare institutions.
              <br />
              <br />
              Our experienced team guides you through the intricate web of laws
              and regulations, ensuring that your practice adheres to all
              necessary legal standards. From conducting compliance audits to
              offering actionable insights, we help you mitigate risks and avoid
              potential pitfalls.
              <br />
              <br />
              Partner with us to streamline your compliance processes, allowing
