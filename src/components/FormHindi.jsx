...
function FormHindi() {
  ...
  return (
    <div>
      <div
        className="scroll-mt-24 min-h-screen bg-white flex items-center justify-center px-4 py-10"
        id="contact"
      >
        <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-10 bg-white">
          {/* Form Section */}
          <div className="flex-1">
            <p className="text-[#32aa27] font-semibold uppercase text-lg">
              संपर्क में रहो
            </p>
            ...
            >
              ...
              <div className="flex items-start text-base">
                ...
                <label>
                  मैं इस वेबसाइट को अपनी प्रविष्टियां संग्रहीत करने की अनुमति
                  देता हूं ताकि वे मेरी पूछताछ का जवाब दे सकें।
                </label>
              </div>
          ...
          <div className="flex-1 bg-gray-100 rounded-lg p-6 md:m-24 md:p-8 space-y-6 text-base shadow-md">
            <div>
              <h3 className="text-2xl font-bold mb-2">संपर्क में रहें</h3>
            ...
            <div>
              ...
              <ul className="text-gray-700 space-y-1 text-base sm:text-lg">
                ...
                <li>
                  बुधवार   &nbsp;&nbsp;&nbsp; सुबह 9:00 बजे – रात 10:00 बजे
                </li>
                <li>
                  गुरुवार    &nbsp;&nbsp;&nbsp;सुबह 9:00 बजे – रात 10:00 बजे
                </li>
