...
function Card1() {
  return (
    <>
      ...
      >
        ...
        <div className="w-full md:w-1/2 md:pl-12">
          ...
          <p className="text-justify text-gray-800 text-base leading-relaxed mb-6">
            Navigating the complexities of medico-legal disputes requires
            precision and expertise. At R&A Legal and Insurance Consultancy, we
            specialize in comprehensive handling of such disputes, ensuring that
            healthcare professionals receive the protection and representation
            they deserve.
            <br />
            <br />
            Our team is well-versed in the intricacies of healthcare law and
            litigation, providing strategic advice tailored to each unique case.
            We aim to resolve conflicts efficiently, allowing medical
            practitioners to focus on their primary goal—delivering exceptional
            care.
            <br />
            <br />
            Trust us to stand by your side during these challenging times,
            guiding you through every step with clarity and confidence.
          </p>
          <Link
            to="/Meeting"
      ...
      <div className="w-full px-6 md:px-20 mt-12">
