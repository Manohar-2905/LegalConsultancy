      ...
      <div id="Card21" className="pt-30 md:pt-50 md:pb-30 flex flex-col md:flex-row items-center justify-center px-6 md:px-20">
        ...
        <div className="w-full md:w-1/2 md:pl-12">
          ...
          <p className="text-justify text-gray-800 text-base leading-relaxed mb-6">
            लगातार विकसित हो रहे स्वास्थ्य सेवा परिदृश्य में, चिकित्सकों के लिए मजबूत बीमा कवरेज हासिल करना महत्वपूर्ण है।
            आरएंडए लीगल एंड इंश्योरेंस कंसल्टेंसी विशेष रूप से स्वास्थ्य सेवा क्षेत्र के लिए डिज़ाइन की गई बीमा सलाहकार सेवाएँ प्रदान करती है।
            <br /><br />
            हमारे विशेषज्ञों की टीम अस्पतालों, क्लीनिकों और व्यक्तिगत चिकित्सकों को उनके अभ्यास की सुरक्षा के लिए सही पेशेवर क्षतिपूर्ति और जोखिम कवरेज विकल्पों की पहचान करने में सहायता करती है।
            हम आपकी अनूठी ज़रूरतों का विश्लेषण करते हैं और आपके हितों की रक्षा करते हुए कानूनी मानकों के अनुपालन को सुनिश्चित करते हुए रणनीतिक सिफारिशें प्रदान करते हैं।
            <br /><br />
